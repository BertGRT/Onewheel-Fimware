...
#define CTRL_MOD_REQ    VLT_MODE        // ONEWHEEL : VLT gere mieux le couple a l'arret (halls) ; 25A pour le couple
#define DIAG_ENA        1               // [-] Motor Diagnostics enable flag: 0 = Disabled, 1 = Enabled (default)

// Limitation settings
#define I_MOT_MAX       25              // [A] ONEWHEEL : monte pour le couple (surveille la chauffe MOSFET !)
#define I_DC_MAX        27              // [A] = I_MOT_MAX + 2A
...
#define BEEPS_BACKWARD            0       // 0 or 1  (onewheel : pas de bip conduite)
...
// Conversion ONEWHEEL : AUCUNE entree de commande externe. La commande vient de
// la boucle d'equilibrage (MPU) injectee dans pwml/pwmr (voir main.c).
// -> laisse PA2/PA3 libres pour l'I2C de la MPU, et USART/ADC non configures.
#ifdef VARIANT_ONEWHEEL
  #define PRI_INPUT1             3, -1000, 0, 1000, 0    // non utilise (reste a 0)
  #define PRI_INPUT2             3, -1000, 0, 1000, 0    // non utilise (reste a 0)
  #define FLASH_WRITE_KEY        0x1099
  // Reglage via l'interface web -> passerelle Python/OpenOCD sur le ST-Link (SWD).
  // Pas de liaison serie necessaire.
#endif
